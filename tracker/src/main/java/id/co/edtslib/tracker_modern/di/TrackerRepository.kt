...
import id.co.edtslib.tracker_modern.data.Configuration
import id.co.edtslib.tracker_modern.data.InstallReferer
import id.co.edtslib.tracker_modern.data.Result
import id.co.edtslib.tracker_modern.data.TrackerActivityCore
import id.co.edtslib.tracker_modern.data.TrackerClickLinkCore
import id.co.edtslib.tracker_modern.data.TrackerData
import id.co.edtslib.tracker_modern.data.TrackerDataList
import id.co.edtslib.tracker_modern.data.TrackerDisplayedItemCore
import id.co.edtslib.tracker_modern.data.TrackerFilterCore
import id.co.edtslib.tracker_modern.data.TrackerFilterDetail
import id.co.edtslib.tracker_modern.data.TrackerImpressionCore
import id.co.edtslib.tracker_modern.data.TrackerNetwork
import id.co.edtslib.tracker_modern.data.TrackerPageDetailCore
import id.co.edtslib.tracker_modern.data.TrackerPageViewCore
import id.co.edtslib.tracker_modern.data.TrackerRemoteDataSource
import id.co.edtslib.tracker_modern.data.TrackerResponse
import id.co.edtslib.tracker_modern.data.TrackerSearchCore
import id.co.edtslib.tracker_modern.data.TrackerSortCore
import id.co.edtslib.tracker_modern.data.TrackerSubmissionCore
import id.co.edtslib.tracker_modern.data.TrackerUser
...
class TrackerRepository (
    ...
    override fun trackApplication(eventName: String) = flow {
        ...
        val trackerData = TrackerData(
            core = trackerCore,
            user = TrackerUser.create(
                configurationLocalSource.getSessionId(),
                configurationLocalSource.getUserId()
            ),
            application = localSource.apps,
            network = TrackerNetwork.create(
                configurationLocalSource.getLatitude(),
